...
from SparrowRobot import MONGO_DB_URI
...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        import importlib
        import SparrowRobot.events

        path = Path(f"SparrowRobot/modules/{shortname}.py")
        name = "SparrowRobot.modules.{}".format(shortname)
        ...
        mod.SparrowRobot = SparrowRobot
        mod.tbot = telethn
        mod.logger = logging.getLogger(shortname)
        spec.loader.exec_module(mod)
        sys.modules["SparrowRobot.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "SparrowRobot/modules/*.py"
