...
from YoneRobot import OWNER_ID, BOT_ID
from YoneRobot import telethn as tbot
import YoneRobot.modules.sql.aihelp_sql as sql
import YoneRobot.modules.sql.chatbot_sql as ly
...
string = (
  "I belong To KITTU!",
  "Im Fairly Yound And Was Made by @A_viyu!",
)
