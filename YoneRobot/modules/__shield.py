...
__help__ = """
<b> Group Guardian: </b>
✪ Sparrow can protect your group from NSFW senders, Slag word users and also can force members to use English
...
Note: Special credits goes to julia project snd friday userbot
